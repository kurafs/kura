...
var noop = func(_ *mountConfig) error { return nil }

// TODO(irfansharif): Document, as in jacobsa/fuse. Move it down below. Possibly
// separate file. Possibly export. Possibly inline with Mount type.
